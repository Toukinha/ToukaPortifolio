...
export default function ProjectDetails({ project }: ProjectDetailsProps) {
  return (
    <section className="w-full sm:min-h-[750px] flex flex-col items-center justify-end relative pb-10 sm:pb-24 py-24 px-6 overflow-hidden">
      ...
      />
      <motion.div
        className="text-gray-400 text-center max-w-[640px] my-4 text-sm sm:text-base"
      ...
      <div className="w-full max-w-[370px] flex flex-wrap gap-2 items-center justify-center">
      ...
      <motion.div
        className="my-6 sm:my-12 flex items-center gap-2 sm:gap-2 flex-col sm:flex-row"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        exit={{ opacity: 0, y: 50 }}
        transition={{ duration: 0.5 }}
